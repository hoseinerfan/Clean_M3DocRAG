...
OUT_DIR="${OUT_DIR:-$REPO_ROOT/output/m3docvqa_content_aware_learned_alpha_action_page5}"
LABEL="${LABEL:-mmqa_train_to_dev_content_aware_learned_alpha_action_page5}"
...
QUERY_ALPHA_ACTION_EPOCHS="${QUERY_ALPHA_ACTION_EPOCHS:-300}"
QUERY_ALPHA_ACTION_LEARNING_RATE="${QUERY_ALPHA_ACTION_LEARNING_RATE:-0.03}"
QUERY_ALPHA_ACTION_WEIGHT_DECAY="${QUERY_ALPHA_ACTION_WEIGHT_DECAY:-1e-3}"
...
echo
echo "== M3DocVQA content-aware learned alpha action =="
...
LEARNED_ALPHA_ACTION=1 \
TUNE_HIT_K="$TUNE_HIT_K" \
TUNE_BLEND_ALPHA_GRID="$TUNE_BLEND_ALPHA_GRID" \
QUERY_ALPHA_FEATURE_TOP_K="$QUERY_ALPHA_FEATURE_TOP_K" \
QUERY_ALPHA_ACTION_EPOCHS="$QUERY_ALPHA_ACTION_EPOCHS" \
QUERY_ALPHA_ACTION_LEARNING_RATE="$QUERY_ALPHA_ACTION_LEARNING_RATE" \
QUERY_ALPHA_ACTION_WEIGHT_DECAY="$QUERY_ALPHA_ACTION_WEIGHT_DECAY" \
...
echo
echo "== Learned alpha action recall table =="
run_args=(
  --run "gpp_no_hyperlink=$EVAL_BASE_PRED"
  --run "learned_alpha_action=$PRED_PATH"
)
