...
DATA_ROOT="${MMDOCIR_DATA_ROOT:-$LOCAL_DATA_DIR/mm-docir}"
EMBEDDING_NAME="${MMDOCIR_EMBEDDING_NAME:-colpali-v1.2_mm-docir_dev}"
BASELINE_PRED="${MMDOCIR_BASELINE_PRED:-$LOCAL_OUTPUT_DIR/mmdocir/baseline_ret1000.json}"
OUT_DIR="${MMDOCIR_OUT_DIR:-$LOCAL_OUTPUT_DIR/mmdocir}"
TOP_PAGES="${MMDOCIR_TOP_PAGES:-1000}"
