#!/usr/bin/env bash
#SBATCH --job-name=mpdocvqa-index-retrieve
#SBATCH --partition=gpu
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=128G
#SBATCH --time=24:00:00
#SBATCH --output=/mmfs1/scratch/jacks.local/aerfanshekooh/custom/MPDocVQA_M3DocRAG/logs/index_retrieve_%j.out
#SBATCH --error=/mmfs1/scratch/jacks.local/aerfanshekooh/custom/MPDocVQA_M3DocRAG/logs/index_retrieve_%j.err
...
INDEX_DIR="${INDEX_DIR:-$LOCAL_EMBEDDINGS_DIR/colpali-v1.2_mpdocvqa_dev_pageindex_ivfflat}"
OUT_DIR="${OUT_DIR:-$LOCAL_OUTPUT_DIR/mpdocvqa}"
