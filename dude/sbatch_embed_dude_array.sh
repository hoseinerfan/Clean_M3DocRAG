...
#SBATCH --array=0-31
#SBATCH --output=/mmfs1/scratch/jacks.local/aerfanshekooh/custom/DUDE_M3DocRAG/logs/embed_%A_%a.out
#SBATCH --error=/mmfs1/scratch/jacks.local/aerfanshekooh/custom/DUDE_M3DocRAG/logs/embed_%A_%a.err
...
DATA_ROOT="${DATA_ROOT:-$LOCAL_DATA_DIR/dude}"
EMBEDDING_DIR="${EMBEDDING_DIR:-$LOCAL_EMBEDDINGS_DIR/colpali-v1.2_dude_dev}"
