...
EMBEDDING_NAME="${EMBEDDING_NAME:-colpali-v1.2_dude_dev}"
BASELINE_PRED="${BASELINE_PRED:-$LOCAL_OUTPUT_DIR/dude/baseline_ret1000.json}"
OUT_DIR="${OUT_DIR:-$LOCAL_OUTPUT_DIR/dude}"
