...
DATA_ROOT="${DUDE_DATA_ROOT:-$LOCAL_DATA_DIR/dude}"
EMBEDDING_NAME="${DUDE_EMBEDDING_NAME:-colpali-v1.2_dude_dev}"
BASELINE_PRED="${DUDE_BASELINE_PRED:-$LOCAL_OUTPUT_DIR/dude/baseline_ret1000.json}"
OUT_DIR="${DUDE_OUT_DIR:-$LOCAL_OUTPUT_DIR/dude}"
TOP_PAGES="${DUDE_TOP_PAGES:-1000}"
