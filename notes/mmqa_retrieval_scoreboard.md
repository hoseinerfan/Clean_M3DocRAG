...
- DUDE is prepared and now has dense baseline plus `plain_top224` retrieval results. Next run SPLADE and Graph-PPR.
...
| DUDE | yes | yes | DUDE OCR in manifest | no | run SPLADE, then Graph-PPR |
