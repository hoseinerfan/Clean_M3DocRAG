#!/usr/bin/env bash
#SBATCH --job-name=opendocvqa-embed
...
#SBATCH --array=0-15
#SBATCH --output=/mmfs1/scratch/jacks.local/aerfanshekooh/custom/OpenDocVQA_M3DocRAG/logs/embed_%A_%a.out
#SBATCH --error=/mmfs1/scratch/jacks.local/aerfanshekooh/custom/OpenDocVQA_M3DocRAG/logs/embed_%A_%a.err
