#!/usr/bin/env bash
#SBATCH --job-name=opendocvqa-top224
...
#SBATCH --array=0-63%4
#SBATCH --output=/mmfs1/scratch/jacks.local/aerfanshekooh/custom/OpenDocVQA_M3DocRAG/logs/plain_top224_%A_%a.out
#SBATCH --error=/mmfs1/scratch/jacks.local/aerfanshekooh/custom/OpenDocVQA_M3DocRAG/logs/plain_top224_%A_%a.err
...
BASELINE_PRED="${BASELINE_PRED:-$LOCAL_OUTPUT_DIR/opendocvqa/baseline_ret${TOP_PAGES}.json}"
OUT_DIR="${OUT_DIR:-$LOCAL_OUTPUT_DIR/opendocvqa/plain_top224_ret${TOP_PAGES}_shards}"
