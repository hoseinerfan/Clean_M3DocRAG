...
#SBATCH --array=0-15
#SBATCH --output=/mmfs1/scratch/jacks.local/aerfanshekooh/custom/ViDoRe_M3DocRAG/logs/embed_%A_%a.out
#SBATCH --error=/mmfs1/scratch/jacks.local/aerfanshekooh/custom/ViDoRe_M3DocRAG/logs/embed_%A_%a.err
...
"$PYTHON_BIN" mmdocir/run_page_embedding_mmdocir.py \
  ...
  --output-dir "$LOCAL_EMBEDDINGS_DIR/colpali-v1.2_vidore-v3_dev" \
