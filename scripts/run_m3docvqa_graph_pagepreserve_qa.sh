...
if [[ "$NUM_SHARDS" -gt 1 ]]; then
  DEFAULT_OUTPUT_LABEL="mmqa_${SPLIT}_plain_top224_splade_graph_pagepreserve_${GRAPH_PROFILE}_qwen2vl_top${QA_TOP_PAGES}_shard${SHARD_ID}_of_${NUM_SHARDS}"
else
  DEFAULT_OUTPUT_LABEL="mmqa_${SPLIT}_plain_top224_splade_graph_pagepreserve_${GRAPH_PROFILE}_qwen2vl_top${QA_TOP_PAGES}"
fi
OUTPUT_LABEL="${OUTPUT_LABEL:-$DEFAULT_OUTPUT_LABEL}"
