...
REFERENCE_PRED="${REFERENCE_PRED:-$OUT_DIR/${DATA_NAME}_subset100_cb_comp_s100.prediction.json}"
PRIMARY_CANDIDATE="${PRIMARY_CANDIDATE:-$OUT_DIR/${DATA_NAME}_subset100_qlsoft_bnd_c5_w6_f025_s100_m100.prediction.json}"
...
SPLADE_KNN_LABEL="${SPLADE_KNN_LABEL:-${DATA_NAME}_subset100_splade_knn_top${SPLADE_KNN_TOP_K}}"
...
SUPPORT_LABEL="${SUPPORT_LABEL:-${DATA_NAME}_subset100_support_splade_knn}"
...
SELECTOR_LABEL="${SELECTOR_LABEL:-${DATA_NAME}_subset100_selector_splade_knn_consensus}"
