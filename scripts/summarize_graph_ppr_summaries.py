...
RECALL_TABLE_COLUMNS = [
    ...
    "doc_doc_edge_weight",
    "doc_doc_top_docs",
    "doc_doc_max_edges_per_doc",
    "doc_doc_embedding_pooling",
    "doc_doc_embedding_page_top_k",
    "doc_doc_embedding_min_similarity",
    "doc_doc_embedding_mutual_top_k",
    "doc_doc_rescue_anchor_top_k",
    "doc_doc_rescue_rank_min",
    "doc_doc_rescue_rank_max",
    "doc_doc_confidence_mode",
    "doc_doc_confidence_margin",
