...
DATA_ROOT="${DATA_ROOT:-$LOCAL_DATA_DIR/vidoseek}"
EMBEDDING_NAME="${EMBEDDING_NAME:-colpali-v1.2_vidoseek_dev}"
BASELINE_PRED="${BASELINE_PRED:-$LOCAL_OUTPUT_DIR/vidoseek/baseline_ret1000.json}"
OUT_DIR="${OUT_DIR:-$LOCAL_OUTPUT_DIR/vidoseek}"
